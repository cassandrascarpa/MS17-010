...
def _put_trans_data(transCmd, parameters, data, noPad=False):
  ...
  if len(data):
    ...
    if isinstance(data, bytes):
        ...
        transData += (b'\x00' * padLen) + data.encode('utf-8')
...
class MYSMB(smb.SMB):
  ...
  def create_trans_packet(self, setup, param='', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
  ...
  def create_trans_secondary_packet(self, mid, param='', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
  ...
  def create_trans2_packet(self, setup, param='', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
    if maxSetupCount is None:
      maxSetupCount = len(setup)
    if totalParameterCount is None:
      totalParameterCount = len(param)
  ...
  def create_trans2_secondary_packet(self, mid, param='', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
  ...
  def create_nt_trans_packet(self, function, setup='', param='', data=b'', mid=None, maxSetupCount=None, totalParameterCount=None, totalDataCount=None, maxParameterCount=None, maxDataCount=None, pid=None, tid=None, noPad=False):
    if maxSetupCount is None:
      maxSetupCount = len(setup)
    if totalParameterCount is None:
      totalParameterCount = len(param)
  ...
  def create_nt_trans_secondary_packet(self, mid, param='', paramDisplacement=0, data=b'', dataDisplacement=0, pid=None, tid=None, noPad=False):
